...
#This file generates test data for other argument models mentioned in the paper
if __name__ == "__main__":
    ...
    for key in test_set:
        print "\n\n\n*******************", key, "*******************\n\n\n"
        sentIndex, entityIdDict, entityIndexDict, eventIdDict, eventIndexDict = cPickle.load(open(processedpathtest + key + ".pkl", 'rb'))
