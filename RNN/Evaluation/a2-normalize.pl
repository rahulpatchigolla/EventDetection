...
foreach my $fname (@ARGV) {
    ...
    &read_text_file("$gDir/PMID-$pmid.txt");
    &read_a1_file("$gDir/PMID-$pmid.a1");
    &read_a2_file($fname);
	...
	my %argorder = (('Theme', 0), ('Theme1', 1), ('Theme2', 2), ('Theme3', 3), ('Theme4', 4), ('Theme5', 5), ('Theme6', 6), ('Cause', 7),
			('Site', 10), ('Site1', 11), ('Site2', 12), ('Site3', 13), ('Site4', 14), ('Site5', 15), ('Site6', 16), ('CSite', 17), ('AtLoc', 18),('ToLoc', 19),('Instrument',20));
