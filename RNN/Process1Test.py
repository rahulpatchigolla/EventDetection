...
testpath="./Preprocessed_Corpus_test/"
#This file generates the pickle files(test data) which store the representational information regarding the data for sentence extractor to work
...
def printEntitiesAndEvents(fileName,entityIdDict,entityIndexDict,eventIdDict,eventIndexDict,content,sentIndex):
    for index in range(0,len(sentIndex)):
        ...
        for event in ListOfevents:
            print event
        print '\n'
    cPickle.dump([sentIndex,entityIdDict,entityIndexDict,eventIdDict,eventIndexDict],open("./Preprocessed_Corpus_test/"+fileName+".pkl","wb"))
...
if __name__ == "__main__":
    ...
    cPickle.dump(entityVocab, open("./Preprocessed_Corpus_test/entityVocab.pkl", "wb"))
    cPickle.dump(eventVocab, open("./Preprocessed_Corpus_test/eventVocab.pkl", "wb"))
    cPickle.dump(wordVocab, open("./Preprocessed_Corpus_test/wordVocab.pkl", "wb"))
